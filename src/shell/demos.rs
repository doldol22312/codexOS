...
pub(super) fn handle_gfxdemo_command() {
...
pub(super) fn handle_uidemo_command() {
    let Some((fb_width, fb_height)) = vga::framebuffer_resolution() else {
...
pub(super) fn handle_uidemo2_command() {
    let Some((fb_width, fb_height)) = vga::framebuffer_resolution() else {
    ...
    let nodes = vec![
        ...
        ui::TreeNode::new("ui/mod.rs", 2, false, true),
        ui::TreeNode::new("shell/mod.rs", 2, false, true),
...
pub(super) fn handle_windemo_command() {
    let Some((fb_width, fb_height)) = vga::framebuffer_resolution() else {
...
pub(super) fn handle_desktop_command() {
    let Some((fb_width, fb_height)) = vga::framebuffer_resolution() else {
...
pub(super) fn handle_multdemo_command<'a, I>(mut parts: I)
where
